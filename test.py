...
class TestCalculateDuty(unittest.TestCase):
    def test_positive_values(self):
        ...
        self.assertAlmostEqual(calculate_duty(1000, 'A'), 50.0)
        self.assertAlmostEqual(calculate_duty(2000, 'B'), 200.0)
        self.assertAlmostEqual(calculate_duty(1500, 'C'), 225.0)
    ...
    def test_edge_cases(self):
        ...
        self.assertAlmostEqual(calculate_duty(0, 'A'), 0.0)
